...
from chat.views import health_check, homepage, mypage, frontend_chat, admin_dashboard, admin_toggle_content, admin_toggle_knowledge, aboutme_page, gallery_page, news_page, video_page, membership_page
...
urlpatterns = [
    ...
    path('aboutme/', aboutme_page, name='aboutme'),
