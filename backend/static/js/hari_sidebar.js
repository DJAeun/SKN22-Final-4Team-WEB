...
const HARI_DATA = {
  ...
  faq: [
    ...
    {
      question: "멤버십 혜택이 뭐야?",
      answer: "fan, fan+, bori 세 가지 구독 상품이 있어! 구독하면 콘텐츠 이용 혜택이랑 매월 SARI도 받을 수 있어 ✨ 멤버십 페이지에서 가격이랑 상품 구성 확인해봐!"
    },
    {
      question: "SARI가 뭐야?",
      answer: "하리와 채팅하거나 롤플레잉할 때 쓰는 포인트야! 채팅은 1턴에 10 sari, 롤플레잉은 1턴에 20 sari가 필요해. 구독하면 기본 SARI를 받고, 더 필요하면 멤버십 페이지에서 추가 충전도 할 수 있어 💎"
    },
    {
      question: "팬이 되려면 어떻게 해?",
      answer: "일단 회원가입하고 멤버십 페이지에서 fan, fan+, bori 중 하나를 구독하면 돼! 그리고 지금처럼 나한테 말 걸어줘 😆💕"
    }
  ],
  ...
  chatSummaries: [
    ...
    },
    {
      date: "2026-03-31",
      label: "3월 31일",
      preview: "SARI랑 롤플레잉에 대해 물어봤어 ✨",
      topics: ["SARI 안내", "HARI Plus"]
    }
  ]
};
